...
!function (t, e) {
    ...
    function D(t, e, n) {
        return (void 0 === n ? t : t.slice(0, function (t, e, n) {
            ...
            t.enabled && o(n) && (e.offsets.popper = m(e.offsets.popper),
    ...
    function L() {
        this.state.eventsEnabled || (this.state = function (t, e, n, i) {
            n.updateBound = i,
                N(t).addEventListener("resize", n.updateBound, {
                    passive: !0
                });
            var r = l(t);
    ...
    function P() {
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate),
            this.state = function (t, e) {
                return N(t).removeEventListener("resize", e.updateBound),
    ...
    for (var W = function (t) {
            ...
            , f = function () {
                ...
                return r.close = function (t) {
                    ...
                    r._removeElement = function (e) {
                        var n = this;
                        t(e).removeClass(c),
                            W.supportsTransitionEnd() && t(e).hasClass(l) ? t(e).one(W.TRANSITION_END, function (t) {
        ...
        return t(document).on(s.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)),
        ...
        var e = "carousel"
            ...
            , T = function () {
                ...
                return T.next = function () {
                    ...
                    T.pause = function (e) {
                        e || (this._isPaused = !0),
                            t(this._element).find(y.NEXT_PREV)[0] && W.supportsTransitionEnd() && (W.triggerTransitionEnd(this._element),
                                this.cycle(!0)),
                    ...
                    T._slide = function (e, n) {
                        var i, r, o, s = this, a = t(this._element).find(y.ACTIVE_ITEM)[0], l = this._getItemIndex(a), f = n || a && this._getItemByDirection(e, a), p = this._getItemIndex(f), T = Boolean(this._interval);
                        if (e === c ? (i = v,
                            r = E,
                            o = h) : (i = _,
                                r = b,
                            ...
                            if (!this._triggerSlideEvent(f, o).isDefaultPrevented() && a && f) {
                                ...
                                W.supportsTransitionEnd() && t(this._element).hasClass(m) ? (t(f).addClass(r),
                                    W.reflow(f),
                                    t(a).addClass(i),
                                    t(f).addClass(i),
                                    t(a).one(W.TRANSITION_END, function () {
                                        t(f).removeClass(i + " " + r).addClass(g),
        ...
        return t(document).on(d.CLICK_DATA_API, y.DATA_SLIDE, T._dataApiClickHandler),
                ...
                return s.toggle = function () {
                    ...
                    s.show = function () {
                        ...
                        if (!this._isTransitioning && !t(this._element).hasClass(f)) {
                            var i, r;
                            if (this._parent && ((i = t.makeArray(t(this._parent).children().children(m.ACTIVES))).length || (i = null)),
                                !(i && (r = t(i).data(n)) && r._isTransitioning)) {
                                var s = t.Event(c.SHOW);
                                if (t(this._element).trigger(s),
                                    !s.isDefaultPrevented()) {
                                    i && (o._jQueryInterface.call(t(i), "hide"),
                                        r || t(i).data(n, null));
                                    var a = this._getDimension();
                                    t(this._element).removeClass(h).addClass(u),
                                        this._element.style[a] = 0,
                                        this._triggerArray.length && t(this._triggerArray).removeClass(d).attr("aria-expanded", !0),
                                    ...
                                    if (W.supportsTransitionEnd()) {
                                        ...
                                        t(this._element).one(W.TRANSITION_END, l).emulateTransitionEnd(600),
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(f)) {
                            ...
                            if (t(this._element).trigger(n),
                                ...
                                if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px",
                                    ...
                                    t(this._element).addClass(u).removeClass(h).removeClass(f),
                                ...
                                var a = function () {
                                    e.setTransitioning(!1),
                                        t(e._element).removeClass(u).addClass(h).trigger(c.HIDDEN)
                                };
                                this._element.style[i] = "",
                                    W.supportsTransitionEnd() ? t(this._element).one(W.TRANSITION_END, a).emulateTransitionEnd(600) : a()
                            }
                        }
                    }
                    ,
                    ...
                    s._getParent = function () {
                        var e = this
                            , n = null;
                        W.isElement(this._config.parent) ? (n = this._config.parent,
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function (t, e) {
                        ...
                        return y = Math.max(Math.min(a[f] - g, y), 0),
                            t.arrowElement = i,
                            t.offsets.arrow = (n = {},
                                $(n, u, Math.round(y)),
                                $(n, d, ""),
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        var s = void 0 !== o ? o : e.gpuAcceleration
                            ...
                            , p = void 0
                            , g = void 0;
                        if (g = "bottom" === h ? -a.height + f.bottom : f.top,
                        ...
                        return t.attributes = tt({}, E, t.attributes),
        ...
        , ot = function () {
            function t(e, n) {
                ...
                Z(this, t),
                    ...
                    Object.keys(tt({}, t.Defaults.modifiers, r.modifiers)).forEach(function (e) {
                ...
                value: function () {
                    return function () {
                        if (!this.state.isDestroyed) {
                            ...
                            t.offsets.reference = T(this.state, this.popper, this.reference),
    ...
    var st = function (t) {
                        ...
                        if (s._clearMenus(),
                            ...
                            if (t(e).trigger(r),
                                ...
                                if (!this._inNavbar) {
                                    ...
                                    var o = this._element;
                                    t(e).hasClass(h) && (t(this._menu).hasClass(g) || t(this._menu).hasClass(p)) && (o = e),
                                        "scrollParent" !== this._config.boundary && t(e).addClass(m),
                                        this._popper = new ot(o, this._menu, this._getPopperConfig())
                                }
                                "ontouchstart" in document.documentElement && !t(e).closest(b).length && t("body").children().on("mouseover", null, t.noop),
                                    this._element.focus(),
        ...
        , at = function (t) {
                            ...
                            if (e && e.preventDefault(),
                                ...
                                if (t(this._element).trigger(i),
                                    ...
                                    r && (this._isTransitioning = !0),
                                        ...
                                        r ? t(this._element).one(W.TRANSITION_END, function (t) {
            ...
            return t(document).on(l.CLICK_DATA_API, p.DATA_TOGGLE, function (n) {
                var i, o = this, s = W.getSelectorFromElement(this);
                s && (i = t(s)[0]);
                    ...
                    return T.enable = function () {
                        ...
                        T.hide = function (e) {
                            var n = this
                                ...
                                , o = function () {
                                    n._hoverState !== h && i.parentNode && i.parentNode.removeChild(i),
                                        n._cleanTipClass(),
                            ...
                            t(this.element).trigger(r),
                                r.isDefaultPrevented() || (t(i).removeClass(g),
                                    ...
                                    W.supportsTransitionEnd() && t(this.tip).hasClass(p) ? t(i).one(W.TRANSITION_END, o).emulateTransitionEnd(150) : o(),
                                    this._hoverState = "")
                        }
                        ,
                        T.update = function () {
                        ...
                        T._enter = function (e, n) {
                            ...
                            (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()),
                                ...
                                t(n.getTipElement()).hasClass(g) || n._hoverState === h ? n._hoverState = h : (clearTimeout(n._timeout),
                                    n._hoverState = h,
                    ...
                    return g.isWithContent = function () {
                        ...
                        s._jQueryInterface = function (e) {
                            return this.each(function () {
                                ...
                                if ((i || !/destroy|hide/.test(e)) && (i || (i = new s(this, r),
                                    t(this).data(n, i)),
                                    "string" == typeof e)) {
                                    if ("undefined" == typeof i[e])
                                        throw new Error('No method named "' + e + '"');
                ...
                , g = function () {
                    ...
                    return g.refresh = function () {
                        ...
                        g._getConfig = function (n) {
                            ...
                            return W.typeCheckConfig(e, n, l),
                                n
                        }
                        ,
                        ...
                        g._activate = function (e) {
                            ...
                            var i = t(n.join(","));
                            i.hasClass(f) ? (i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(h),
                                i.addClass(h)) : (i.addClass(h),
                                    i.parents(u.NAV_LIST_GROUP).prev(u.NAV_LINKS + ", " + u.LIST_ITEMS).addClass(h),
                                    i.parents(u.NAV_LIST_GROUP).prev(u.NAV_ITEMS).children(u.NAV_LINKS).addClass(h)),
                ...
                , _ = function () {
                    ...
                    return n.show = function () {
                        ...
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(s) || t(this._element).hasClass(a))) {
                            var n, i, o = t(this._element).closest(h)[0], l = W.getSelectorFromElement(this._element);
                            if (o) {
